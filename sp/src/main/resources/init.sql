...
create table if not exists contact_preferences (
    ...
    contact_preferences_email boolean,
    contact_preferences_phone boolean,
    contact_preferences_post boolean,
    contact_preferences_whatsapp boolean,
    contact_preferences_discord boolean,
    contact_preferences_telegram boolean
);

create table if not exists asset_holders (
    asset_holder_id varchar(50) primary key,
