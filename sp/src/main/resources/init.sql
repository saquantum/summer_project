...
('British Museum',   ST_GeomFromText('POLYGON((-0.1289 51.5190, -0.1274 51.5190, -0.1274 51.5205, -0.1289 51.5205, -0.1289 51.5190))', 4326), 1),
('St Paul''s Cathedral', ST_GeomFromText('POLYGON((-0.0998 51.5134, -0.0983 51.5134, -0.0983 51.5149, -0.0998 51.5149, -0.0998 51.5134))', 4326), 1),
('Hyde Park',        ST_GeomFromText('POLYGON((-0.1670 51.5069, -0.1655 51.5069, -0.1655 51.5084, -0.1670 51.5084, -0.1670 51.5069))', 4326), 1),
('London Eye',       ST_GeomFromText('POLYGON((-0.1209 51.5029, -0.1194 51.5029, -0.1194 51.5044, -0.1209 51.5044, -0.1209 51.5029))', 4326), 1),
('The Shard',        ST_GeomFromText('POLYGON((-0.0881 51.5041, -0.0866 51.5041, -0.0866 51.5056, -0.0881 51.5056, -0.0881 51.5041))', 4326), 1),
('Westminster Abbey',ST_GeomFromText('POLYGON((-0.1284 51.4989, -0.1269 51.4989, -0.1269 51.5004, -0.1284 51.5004, -0.1284 51.4989))', 4326), 1),
('Kensington Palace',ST_GeomFromText('POLYGON((-0.1891 51.5054, -0.1876 51.5054, -0.1876 51.5069, -0.1891 51.5069, -0.1891 51.5054))', 4326), 1);
