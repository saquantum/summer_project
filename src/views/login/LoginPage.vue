...
const goToStep3 = async () => {
  const valid = await registerFormRef.value.validateField(['id', 'assetHolder.phone'])
  if (valid) {
...
const getStepTitleClass = (step) => {
  return {
    'step-header-disabled': editingStep.value !== null && editingStep.value !== step
  }
}
      ...
      <el-card class="glass-effect" style="width: 90%; max-width: 400px">
        ...
        >
          ...
          <el-collapse v-model="openSteps">
            ...
            >
              <template #title>
                <div class="collapse-title">
                  <span>Step 1:&nbspYour Email</span>
                </div>
              </template>
              ...
              <template v-else>
                ...
                <el-form-item>
                  <el-button @click="confirmEmail" class="step-button">Continue</el-button>
                </el-form-item>
              </template>
            </el-collapse-item>
            ...
            <el-collapse-item
              name="2"
              :disabled="!stepStatus[1] || (editingStep !== null && editingStep !== 2)"
            >
              <template #title>
                <div class="collapse-title">
                  <span>Step 2:&nbspYour Details</span>
                </div>
              </template>

              <template v-if="editingStep !== 2 && stepStatus[2]">
                <div class="details-line">
                  <span class="details">{{ registerForm.id }}<br />{{ registerForm.assetHolder.phone }}</span>
                  <el-link
              ...
              <template v-else>
                ...
                <el-form-item>
                  <el-button @click="goToStep3" class="step-button">Save and continue</el-button>
                </el-form-item>
              </template>
            </el-collapse-item>
            ...
            <el-collapse-item
              name="3"
              :disabled="!stepStatus[2] || (editingStep !== null && editingStep !== 3)"
              :class="getStepTitleClass(3)"
            >
              <template #title>
                <div class="collapse-title">
                  <span>Step 3:&nbspAccount Info</span>
                </div>
              </template>
              ...
              <template v-else>
                ...
                <el-form-item>
                  <el-button @click="register" class="step-button">SAVE AND CONTINUE</el-button>
                </el-form-item>
              </template>
            </el-collapse-item>
        ...
        >
          ...
          <el-form-item>
            <el-button class="button">Send email</el-button>
          </el-form-item>
