...
class Result(Generic[T]):
    ...
    # def __init__(self, success: bool, value=None, error_msg=None, code: int = None, traceback_str: str = None):
    ...
    #     else:
    #         return f"Failure(error_msg={self.error_msg}, code={self.code})"
    #
    # def __eq__(self, other):
    #     if not instance(other, Result):
    #         return False
    #     else (
